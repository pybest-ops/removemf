...
const sitemapRoutes = ['/', '/pricing', '/faq', '/privacy', '/terms', '/refund', '/matcha-filter-remover', '/blog', '/what-is-matcha-filter', '/how-to-remove-matcha-filter', '/tiktok-remove-matcha-filter', '/youtube-remove-matcha-filter'];
